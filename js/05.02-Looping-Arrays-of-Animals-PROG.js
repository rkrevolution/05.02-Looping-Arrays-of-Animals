...
const animalPicDiv = document.querySelector('#animal-pics');

// get video player div
const videoPlayerDiv = document.querySelector('#video-player')

// get h2 for animal name
const animalNameHeading = document.querySelector('h2');
const animalDescriptionParagraph = document.querySelector('p');
...
animalNameHeading.textContent = animalsArr[0].name;
animalDescriptionParagraph.textContent = animalsArr[0].desc;
